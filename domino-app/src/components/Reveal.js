 ...
 * design. Honors the system reduce-motion setting. On cold open the whole cascade is
 * deferred until the intro overlay starts dissolving, so the first thing seen is
 * content rising through the fade rather than a finished page.
 *
